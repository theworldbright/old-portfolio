            ...
            <div id="post-<?php the_ID(); ?>" <?php post_class('single'); ?>>
                ...
                <div class="post-inner">
                    ...
                    <div class="post-meta-bottom">
                        ...
                        <ul>
                            <li>
                                <?php
                                    $attachment_metadata = wp_get_attachment_metadata(get_post_thumbnail_id(), false);
                                    $image_metadata = $attachment_metadata['image_meta'];
                                    $created_timestamp = $image_metadata['created_timestamp'];
                                    echo date_i18n('F d, Y', $created_timestamp);
                                ?>
                                /* Adjust so that 1970 no metadata stuff gets put to the bottom without any date */
                            </li>
                        </ul>
                ...
                <div class="post-navigation">
                    ...
                    if (!empty($prev_post)): ?>
                        ...
                        <a class="post-nav-prev" title="<?php _e('Previous post', 'fukasawa');
                    ...
                    if (!empty($next_post)): ?>
                        ...
                        <a class="post-nav-next" title="<?php _e('Next post', 'fukasawa');
